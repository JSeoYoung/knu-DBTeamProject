					...
					<div class="row search">
						<div class="dataTables_filter">
							<form action = "get_payment_date.jsp" method="post">
								...
								<a href="#layer2" class="button_menu" role="button">메뉴별 합계보기</a>
								<div class="dim-layer">
									<div class="dimBg"></div>
												...
												<div class="container scroll"
													...
													<table class="table align-center" cellspacing="0"
														...
														<thead>
															<tr class="table-heads">
																<th class="head-item mbr-fonts-style display-7">메뉴</th>
														...
														<tbody>
															<tr>
																<td class="body-item mbr-fonts-style display-7">아메리카노</td>
																<td class="body-item mbr-fonts-style display-7">2500원</td>
																<td class="body-item mbr-fonts-style display-7">2개</td>
																<td class="body-item mbr-fonts-style display-7">5000원</td>
													...
													<table class="table align-center" cellspacing="0"
														...
														<tbody>
															...
															<tr>
																<td class="body-item mbr-fonts-style display-7">카페라떼</td>
																<td class="body-item mbr-fonts-style display-7">3300원</td>
																<td class="body-item mbr-fonts-style display-7">1개</td>
																<td class="body-item mbr-fonts-style display-7">3300원</td>
													...
													<table class="table align-center" cellspacing="0"
														...
														<tbody>
															<tr>
																<td class="body-item mbr-fonts-style display-7">딸기스무디</td>
																<td class="body-item mbr-fonts-style display-7">4300원</td>
																<td class="body-item mbr-fonts-style display-7">1개</td>
																<td class="body-item mbr-fonts-style display-7">4300원</td>
													...
													<table class="table align-center" cellspacing="0"
														...
														<tbody>
															<tr>
																<td class="body-item mbr-fonts-style display-7">밀크티</td>
																<td class="body-item mbr-fonts-style display-7">4000원</td>
																<td class="body-item mbr-fonts-style display-7">2개</td>
																<td class="body-item mbr-fonts-style display-7">8000원</td>
					...
					<div id="layer1" class="pop-layer1">
						<div class="pop-container1">
							<div class="pop-conts">
								...
								<!--<h5 class="text align-center">아메리카노&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5000원</h5>
                <h5 class="text align-center">카페라떼&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3300원</h5>
                <h5 class="text align-center"></h5>
                <h5 class="text align-right">총합: 8300원</h5>-->
								...
								<h5 id="sum" class="text align-right">총합:
									8300원&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
